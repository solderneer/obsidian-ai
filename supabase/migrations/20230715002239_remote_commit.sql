...
CREATE FUNCTION "public"."match_document_sections"("embedding" "public"."vector", "match_threshold" double precision, "match_count" integer, "min_content_length" integer) RETURNS TABLE("id" bigint, "document_id" bigint, "content" "text", "similarity" double precision)
    LANGUAGE "plpgsql"
    AS $$
...
ALTER FUNCTION "public"."match_document_sections"("embedding" "public"."vector", "match_threshold" double precision, "match_count" integer, "min_content_length" integer) OWNER TO "postgres";

CREATE FUNCTION "public"."match_documents"("query_embedding" "public"."vector", "match_count" integer DEFAULT NULL::integer, "filter" "jsonb" DEFAULT '{}'::"jsonb") RETURNS TABLE("id" "text", "content" "text", "metadata" "jsonb", "similarity" double precision)
    LANGUAGE "plpgsql"
    AS $$
...
ALTER TABLE "public"."document_section_id_seq" OWNER TO "postgres";

ALTER SEQUENCE "public"."document_section_id_seq" OWNED BY "public"."document_section"."id";

ALTER TABLE ONLY "public"."document" ALTER COLUMN "id" SET DEFAULT "nextval"('"public"."document_id_seq"'::"regclass");

ALTER TABLE ONLY "public"."document_section" ALTER COLUMN "id" SET DEFAULT "nextval"('"public"."document_section_id_seq"'::"regclass");
...
ALTER TABLE ONLY "public"."document_section"
    ADD CONSTRAINT "document_section_pkey" PRIMARY KEY ("id");

ALTER TABLE ONLY "public"."document_section"
    ADD CONSTRAINT "document_section_document_id_fkey" FOREIGN KEY ("document_id") REFERENCES "public"."document"("id") ON DELETE CASCADE;

CREATE POLICY "Access Public Document Sections" ON "public"."document_section" FOR SELECT USING ((( SELECT "document"."public"
   FROM "public"."document"
  WHERE ("document"."id" = "document_section"."document_id")) = true));

CREATE POLICY "Access Public Documents" ON "public"."document" FOR SELECT USING (("public" = true));
...
GRANT ALL ON FUNCTION "public"."match_document_sections"("embedding" "public"."vector", "match_threshold" double precision, "match_count" integer, "min_content_length" integer) TO "anon";
